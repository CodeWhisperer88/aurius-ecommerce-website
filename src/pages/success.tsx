        ...
        <section className="order-2 mx-auto max-w-screen-xl pb-12 lg:col-span-5 lg:mx-0 lg:max-w-none lg:pr-16 lg:pt-16 xl:pl-16 2xl:pl-44">
          <div className="my-8 ml-4 flex space-x-4 lg:ml-14 xl:ml-0">
            ...
            <div>
              ...
              {/* gives the name of the user if the user is logged in, from nextauth useSession Provider */}
...
//we are able to use sesson_id because it is present on both the client side and the server side.
// This gives us context which in turn gives us query.
